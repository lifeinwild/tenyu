...
私がこの文書で考えているのは**新しいコンピューターやOSの出現を促すよう世界的にソフトウェア資産を整備するにはソフトウェアエコシステムはどうあるべきか**であり、Tenyuプロジェクトのソフトウェア構成はその観点から判断しました。
...
私はTenyuプロジェクトのソフトウェア構成について、まだ実現されていないいくつかの潜在的可能性も考慮して判断しました。
