...
このプロジェクトは以下に述べる構想によって、オンラインゲームのプレイヤーや動画制作者、配信者、プログラマー、その他ソフトウェア制作者やオンラインサービスの提供者等が収益化できる状況を目指します。つまりオープンソースや無料サービスやフリーソフト等について、**有料化する事無く自由な相互利用を保ちながら幅広くネット上での活躍が収益化される状況**を目指します。さらに、様々な創作者が自由に参加できる1つの連合型MMOを構築できます。
