...
Tenyuにオンラインゲームを登録できますが、オンラインゲームの扱いは他の一般的なソフトウェアと異なり、レーティングゲームと常駐空間ゲームの抽象ノードから各オンラインゲームへのエッジがアルゴリズムによって[自動的に作成](#ノードとエッジの種類)されます。  
そして各オンラインゲームはそのプレイヤー動態に貢献していると思しきWebページ、例えばyoutubeの動画ページ等やプレイヤーのブログやwiki等にエッジを作成し、様々なものに報酬が与えられます。
