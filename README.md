...
[オンラインゲーム主軸モデル](#オンラインゲーム主軸モデル)というアイデアによって、もはやそのような[取得を本質としたコンテンツ](#承認情報)は常に[オンラインゲームの衛星作品](#衛星作品)として作成されるべきだ、と考えます。この特殊な判断によって私が構想する作者権によるソフトウェア経済は十分な汎用性を獲得します。映画のような娯楽作品はその形態について必須要件がほとんど存在しないという特性を利用し、ネット時代に適合する形態に変われるだろうということです。他に抽象ノードを使えば衛星作品でなくとも収益化可能です。
