...
Google曰く心理的安全性を高める事が生産性の向上に繋がるらしい。自分の経験上でもそう思える。
それはかつてからゴーレム効果という言葉でその一端が指摘されていたと思う。
創作活動において心理的安全性を高めるには作者権やプロジェクト権の確立が必要になる。
他人の成果をパクろうと狙っている、いわゆるパクラーが存在するようでは、創作者の心理的安全性は阻害される。
...
# 特許冒認問題
ソフトウェア特許に限らずとも以下の条件を満たす発明はかなりの割合で冒認だと思います。
- 専用の実験設備を必要としない思考上の成果
- その分野での想像力を養うのに高価な設備を必要としない
