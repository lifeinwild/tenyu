...
- **地域通貨**のネット版です。その通貨の分配・回収に独自のモデルを持ち、結果的にソフトウェアや知識生産活動の汎用的な収益化システムとして機能します。
- 従来多数の**MMO**がサービス終了ないし衰退してきましたが、持続可能な**MMO**のモデルを提案し、それがTenyuの独自通貨の回収モデルとなります。
- **誰がどんな貢献をしたか**をフローネットワークを用いて記述します。それがTenyuの独自通貨の分配モデルとなります。
