# Tenyuプロジェクトの概要
創作活動による経済を実現するためのプラットフォーム。独自のP2P技術による高性能かつ堅牢な仮想通貨を含む。
質問はissuesへ。レビュー記事歓迎。分からないところを教えてください。

# 特徴、目的  
一般論としてソフトウェアはいくつかの問題を抱えていました。
ソフトウェアを有料化するためにわざわざ一部機能を無効化するコードを入れたり、ソフトウェア特許に関する紛争が増えたり、他の人のソフトウェアに何かアイデアを思いついても自由にソフトウェアを改修できない状況がありました。他にも世界中で使用されるソフトやWEBサイトを作ってもほとんど収益化できない事がありました。  
私はここに示した構想によってそのような問題が根本的に解決できると思っています。  

さらに、MMOにも根本的なモデルの問題がありましたが、それも構想レベルでは解決できたと思っています。  

私の構想は非常に簡略化して述べるとオンラインゲームによって仮想通貨に価値を持たせてあらゆるソフトウェアの収益化をその仮想通貨を用いて解決しようというものです。オンラインゲームがゲーム内通貨に価値を持たせてRMT市場を実現していた事は注目に値します。同様の事を仮想通貨において行います。

誰でも自分の小さなゲームを登録し、それらを連携させて全体として連合型MMOを作ります。さらにオンラインゲームに関連した動画制作等周辺コンテンツも収益化できます。ページ内検索：オンラインゲーム主軸モデル  

ソフトウェアは世界の共用資産となっていくのが正しく、そのための経済モデルを考えた結果、経済について根本的な解釈の変化がありました。ページ内検索：無責任支払い  
