...
- 個人開発者が連携して[連合型MMO](#仮想経済)を作り上げれるP2Pベースのゲームミドルウェア
- ソフトウェアを世界の共用資産とするための[ライセンス](#TenyuLicenseの概要)および[報酬システム](#相互評価フローネットワーク)
...
従来どのような方法が用いられたか。
- MMORPGでPvPをさせると装備差で決着がついてしまう。それが逆に装備を集めるモチベーションになる場合もあるかもしれませんが、多くの場合良い装備がある人の方がゲーム内資産の蓄積ペースが速いので後発はずっと追いつけません。そしてPvPで負け続ける事になります。
...
- 人間関係の構築を楽しむ。様々なオンラインゲームにおいて一貫して共通のアバターを用いる事でそれを助ける。ネトゲがvtuberに対応する。
