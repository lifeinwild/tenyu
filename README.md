...
1つ1つの近傍に全近傍が送ってきたランダム値を全て含めて送信するという事です。そうするのは、回答者が「総合された問題作成情報」に対してのみ回答を計算したからです。つまり1つ1つの近傍が送ってきた問題作成情報に対して直接回答を計算したのではなく、それらを総合した問題作成情報に回答を計算したので、自分が解いた問題を回答に含める必要があるので、総合された問題作成情報を回答に含めます。
