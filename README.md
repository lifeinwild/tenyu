...
ソフトウェアを有料化するためにわざわざ一部機能を無効化するコードを入れたり、ソフトウェア特許に関する紛争が増えたり、他の人のソフトウェアに何かアイデアを思いついても自由に改修できない状況がありました。他にも世界中で使用されるソフトやWEBサイトを作ってもほとんど収益化できない事がありました。  
私はここに示した構想によってそのような問題が根本的に解決できると思っています。  

さらに、MMOにも根本的なモデルの問題がありました。せっかくゲーム内資産を蓄積しても廃れてしまいます。それも構想レベルでは解決できたと思っています。  

ソフトウェアは単純に生産性を考えるとソースコードが公開されて世界の共用資産となっていくのが正しいように思われますが、どのようにしてそれを実現するか。そのための経済モデルを考えた結果、経済について根本的な解釈の変化がありました。ページ内検索：無責任支払い  
