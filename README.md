...
私の考えでは、私がTenyuプロジェクトを通して提案している事は新たな資本強化サイクルです。つまり、政府資本や民間資本等と同次元の新たな概念です。[資本](#資本)  

このプロジェクトは貢献度に応じて報酬を与える[相互評価フローネットワーク](#相互評価フローネットワーク)という仕組みを含みます。あらゆる貢献は相互評価フローネットワークに記述され、それに応じて仮想通貨が分配されます。もしこの構想が実現するなら、参加して評価を得る事で報酬が得られます。評価は参加者の間で相互に行われます。  
抽象ノードという仕組みを通じて任意の対象を仮想通貨分配の対象にできます。[ノードとエッジの種類](#ノードとエッジの種類)  
  
もしあなたが情報技術の専門家なら、まずこのプロジェクトが偽物でないことを確かめるためにプロセッサ証明と分散合意について確認してください。それはブロックチェーンを代替するアイデアです。[P2P技術](#P2P技術)  

たまにネットで活動している人でファンにカンパを求めている人が居ます。例えばyoutubeのスーパーチャットやFANTIAなどです。しかしファンもほとんどの人が十分にお金を持っていない事に気付く必要があります。**Tenyuの構想はネット民が集まって何もないところに価値ある仮想通貨を作り出すというものなので、ネット民に対してより前向きな提案となります**。Tenyuの構想が実現した場合、金が欲しい人達は相互評価フローネットワーク上でエッジを作成してもらえるよう努力する事になり、そして金は共同主体が支払うだけなので（youtuberのようなネットの人気者達が）誰かから金を回収する必要が無いのです。  
...
この難解な話を理解してくれる人を増やすのが目下最大の難関です。特にP2P技術に関して、私はセキュリティが成立していると主張していますが、一般論として脆弱性が無い事を証明する方法は無いと思います。だから理解者が増えなければ全く意味が無いという事です。  
