...
ソフトウェアを有料化するためにわざわざ一部機能を無効化するコードを入れたり、ソフトウェア特許に関する紛争が増えたり、他の人のソフトウェアに何かアイデアを思いついても自由にソフトウェアを改修できない状況がありました。他にも世界中の人々に使用されるソフトを作ってもほとんど収益化できない事がありました。
少なくとも私はここに示した構想によってそのような問題が根本的に解決すると思っています。
さらに、MMOにも根本的なモデルの問題がありましたが、それも構想レベルでは解決できたと思っています。
私の構想は非常に簡略化して述べるとオンラインゲームによって仮想通貨に価値を持たせてあらゆるソフトウェアの収益化をその仮想通貨を用いて解決しようというものです。
ソフトウェアは世界の共用財産となっていくのが正しく、そのための経済モデルを考えた結果、いくつか根本的な解釈の変化がありました。例えば誰にいくら報酬を支払うかを決定する人と報酬を支払う人が違います。全体を代表する仮想的主体のみが報酬を支払うので、ユーザーは誰もソフトウェアに報酬を支払いません。
...
- 様々なゲームで自分のアバターを使用する  
- 創作者の利益と創作の自由を両立する構想
- **オンラインゲームによって余暇を収益化したりオンラインゲームのプレイヤーが経済的理由でリアル破綻しないようにする**。Tenyuプロジェクトは連合型MMOを構想し、多数のオンラインゲームで共通のゲーム内通貨を用いる事になり一部ゲームが衰退したとしてもゲーム内通貨の価値が保たれるという面があります。プレイヤーは必要ならゲーム内通貨をRMTで販売できるでしょう。**ネットで金を稼ぎたい人達は大勢いると思いますが、他人から金を巻き上げるというアイデアは限界があります**。従来MMOがゲーム内通貨に価値をもたせRMT市場を実現していた事に注目してください。何も存在しないところに純粋にオンラインの活動だけで価値を作り出せる可能性があります。
- **ゲームの素材やプログラムや不正行為をしないユーザープール等を各ゲームで共有し簡単に高度なオンラインゲームを制作できるようにする**。相互評価フローネットワークによるソフトウェアの収益化や、それで収益化される事を期待しソフトウェアを利用しやすいライセンスで公開するTenyuLicenseや、基盤ソフトウェアを通じた素材の共有システムやユーザーDBの提供等があります。
...
私が世界的な事を主張するのは、ソフトウェアはネットを通じて世界的に広まるので、ソフトウェアのための経済を構想すると人権等の世界的な概念の修正に思い至るからです。
人権に話が及ぶのは、経済は基本的権利や道徳や信用が全く無いようでは少しも成立しないからです。
