...
[この構想が実現されるべき社会的理由１](#何に価値を感じるべきか)  
[この構想が実現されるべき社会的理由２](#何が価値を決定しているか)
...
本構想の仮想通貨がどのようにその条件をクリアするかを示します。
  ...
  - 誰もが努力すれば獲得できて努力しなければ獲得できないこと。  
    Tenyuにおいて、通貨の分配経路は相互評価フローネットワークで記述され、一人一人のユーザーの判断で、様々な創作的成果における様々な貢献に対してエッジが作成されるので、複雑化します。この点で多様な貢献が評価されると考えています。基本的に公開された成果に基づいてエッジを作成するというルールがありエッジの作成理由を誰もが検証可能で、努力無しでエッジを得る事はできません。つまり身内でエッジを作り合って不正に報酬を得る事は困難です。
...
4  
価値を感じる人が居るから価値を感じる人が増える。
しかし、これは1から説明される。そう判断する人が居るから連れ立って同じように判断する人が居る。
人間の判断が他の人間の判断を追従する場合があるという事で、増幅説は判断説の一部でしかない。
