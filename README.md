...
- 個人開発者が連携して[連合型MMO](#連合型MMO)を作り上げれるP2Pベースのゲームミドルウェア
...
このプロジェクトは[相互評価フローネットワーク](#相互評価フローネットワーク)及びそれを通じた[仮想通貨分配](#仮想通貨分配)によって、オンラインゲームのプレイヤーや動画制作者、配信者、プログラマー、その他ソフトウェア制作者やオンラインサービスの提供者等が[収益化できる状況](#主旨)を目指します。つまりオープンソースや無料サービスやフリーソフト等について、**有料化する事無く[自由な相互利用を保ちながら](#作者権)幅広くネット上での活躍が収益化される状況**を目指します。さらに、様々な創作者が自由に参加できる1つの[連合型MMO](#連合型MMO)を構築できます。
...
それをどうデザインすべきかは非常に難しい問題です。その問題領域はゲームというただの娯楽の問題ではなく[ソフトウェアのための新たな資本モデル](#これは何)を構想する上で本質的な問題です。

Tenyuはその問題領域に対する独自の回答を持ちます。[連合型MMO](#連合型MMO)

# 連合型MMO
連合型MMOは[仮想経済](#仮想経済)の一種で、仮想通貨に価値を持たせる役割があります。念のため[相互評価フローネットワーク](#相互評価フローネットワーク)は仮想経済ではありません。オンラインゲーム部分が仮想経済です。

多数の制作者がそれぞれ小さなゲームを登録して、それらを連携させて連合型MMOを実現します。  
