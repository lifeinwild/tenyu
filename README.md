...
Tenyuは世界のソフトウェアや知識生産を最大化するために、適切な構想や革新的技術や基本的権利の修正やその社会的メリットを主張しています。

構想として、[ソフトウェア制作や知識生産活動を収益化するための汎用的なプラットフォーム](#相互評価フローネットワーク)や、[持続可能なMMO](#連合型MMO)があります。  

革新的技術として、[独自のP2P技術](#P2P技術)による従来技術と比較して桁違いに高性能かつ堅牢な仮想通貨（もちろん通貨以外のデータも扱える）があります。  

基本的権利の修正として、さらに著作権やソフトウェア特許を[作者権](#作者権)に変えるべきと主張しています。

社会的メリットとして、[環境負荷低減のために仮想経済を軸に経済成長しろ](#何に価値を感じるべきか)という政治的主張も含みます。
...
# 仮想経済
仮想経済とはRMT市場を創出しうる仮想的な経済です。典型的にはMMOです。
...
あるいはなぜ人々は仮想的なアイテムに価値を感じるべきか？
  ...
  - [仮想的なアイテムが価値を持つ](#仮想経済)と、外出や物品の消費を伴う趣味と比べて環境負荷を抑えれて、ITの進歩を促進する可能性があり、個人による経済を実現できる可能性があり、社会不適合者の受け皿となる可能性があり、その入手や使用は自宅に居ながらできて手軽であり、副業としてその価値生産に参加できて、あるいはゲームプレイという娯楽の時間を収益化できて、[文化的可能性](#vtuber現象)が飛躍的に広がり、経済がより複雑化し独創的な価値を生産するようになる。だから**それに価値があるという判断が行われる**。
