...
# 仮想経済
仮想経済は私の造語で、説明していくのに必要だったので作成しました。
...
仮想経済をどうデザインすべきかは非常に難しい問題です。その問題領域はゲームというただの娯楽の問題ではなく[ソフトウェアのための新たな資本モデル](#目的)を構想する上で本質的な問題です。私の構想では仮想経済は[相互評価フローネットワーク](#相互評価フローネットワーク)において人々から共同主体へと仮想通貨を回収する流れを実現する役割を持ちます。
