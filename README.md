...
Tenyuは**就職**や**販売**や**寄付**や**投資**といった行為を伴わずにソフトウェアや知識の生産活動を収益化できるプラットフォームです。※制作途中

別の言い方をすれば、Tenyuはいわば地域通貨のネット版で、その通貨の分配・回収に独自のモデルを持ち、結果的にソフトウェアの汎用的な収益化システムとして機能します。
