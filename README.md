...
このプロジェクトは相互評価フローネットワーク及びそれを通じた仮想通貨分配によって、オンラインゲームのプレイヤーや動画制作者、配信者、プログラマー、その他ソフトウェア制作者やオンラインサービスの提供者等が収益化できる状況を目指します。つまりオープンソースや無料サービスやフリーソフト等について、**有料化する事無く自由な相互利用を保ちながら幅広くネット上での活躍が収益化される状況**を目指します。さらに、様々な創作者が自由に参加できる1つの連合型MMOを構築できます。
  
**Tenyuプロジェクトは、参加者から集金する話ではなく、参加者に仮想通貨を与える話です**。  
仮想通貨はいくらでも作り出せるデータで大勢の参加者に与える事が可能です。いくらでも作り出せるからといって必ずしも価値を持たないわけではありません。例えばMMOのゲーム内通貨もいくらでも作り出せるデータですがRMT等で取引されるなど価値を持ちました。参加者数が多く、めちゃくちゃな運用がされないという信頼性があれば、仮想通貨は価値を持ちます。集金する話ではないとは、法定通貨（日本円など）を徴収するような考えが一切ないという事です。  

単純化するとこんな感じです。連合型MMOによって仮想通貨に価値を持たせる、つまり連合型MMOにおける有料アイテムを仮想通貨で購入できて、支払われた仮想通貨は共同主体に回収され、共同主体は相互評価フローネットワークを通じて各種クリエイターら（プレイヤー報酬もある）に仮想通貨を分配します。  
...
さらに、ユーザー全員の投票を通じた意思決定機能があり、全体運営者を選出できます。従来のC/S型では管理者をユーザーが選出する事ができませんでしたが、Tenyuではそれが可能になります。投票プロセスや結果は作者である私や全体運営者ですら改ざんできません。その投票技術は世界的な電子投票を実現しうる重要なものです。  
  
私の考えでは、私がTenyuプロジェクトを通して提案している事は新たな資本強化サイクルです。つまり、政府資本や民間資本等と同次元の新たな概念です。  
このプロジェクトは貢献度に応じて報酬を与える相互評価フローネットワークという仕組みを含みます。もしこの構想が実現するなら、参加して評価を得る事で報酬が得られます。評価は参加者の間で相互に行われます。抽象ノードという仕組みを通じて任意の対象を仮想通貨分配の対象にできます。  
...
たまにネットで活動している人でファンにカンパを求めている人が居ます。例えばyoutubeのスーパーチャットやFANTIAなどです。しかしファンもほとんどの人が十分にお金を持っていない事に気付く必要があります。**Tenyuの構想はネット民が集まって何もないところに価値ある仮想通貨を作り出すというものなので、ネット民に対してより前向きな提案となります**。Tenyuの構想が実現した場合、金が欲しい人達は相互評価フローネットワーク上でエッジを作成してもらえるよう努力する事になり、そして金は共同主体が支払うだけなので（youtuberのようなネットの人気者達が）誰かから回収する必要が無いのです。（広く見れば連合型MMOによって回収されるが）
...
## 独自用語  
各用語がこの用語ツリーのどの位置にあるかを確認してください。祖先、兄弟、子孫の概念は関係ありますが、それ以外の概念は無関係です。
- P2P技術   
...
この文書に書かれている事は大まかにいうと、P2P技術（P2Pプラットフォームの確立過程及び継続的保護システム）と、そのP2Pプラットフォームで何をするかという事に分かれます。以下、後者についての説明です。基本的に客観DBの内容は自由であり、C/S同様にほとんど任意のサービスを実現できると思っておいておおよそ間違いありません。とはいえ、クラウドと比べたらスケーラビリティに気を遣う必要があります。
  - ユーザー登録  
  ...
  - 連合型MMO   
  多数の異なる制作者が小さなゲームを登録して、それらを連携させて連合型MMOを実現します。連合型MMOの長所は、1つのゲームが廃れるだけでは全体に影響が無い事です。全ゲームで共通の通貨やユーザーDBを使います。連合型MMOのアイテムを仮想通貨で購入すると共同主体の仮想通貨残高へ回収されます。この点で連合型MMOは本構想のエンジンであると言えます。
    - レーティングゲーム  
...
A.ブロックチェーンではありません。分散合意とプロセッサ証明は、ブロックチェーンを代替する新しいP2P技術です。民主主義的な側面はあります。従来、オンラインゲームはプレイヤーが構築した仮想価値を無視したアップデートをしたり、サービスを終了しました。しかし共同主体という概念は選挙的プロセスを持ち、参加者の意見を無視した決定が難しくなります。詩的に言えば、共同主体は仮想的価値を守っていく1個の生物のようなものに思えます。  
