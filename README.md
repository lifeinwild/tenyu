...
- **政治家がどう経済成長するのか環境問題をどうするのかなど議論している事がありますが**、Tenyuはそのような問題への[独自の回答](#何に価値を感じるべきか)を持ちます。ソフトウェアという新しい領域を適切なモデルで経済化し、[経済成長の軸をソフトウェアやMMOに移す事による環境負荷の軽減](#何に価値を感じるべきか)。
...
**[Tenyuプロジェクトは参加者から集金する話ではなく、参加者にTenyuの連合型MMOで使用できる仮想通貨を与える話です](#回収ではなく与えるプロジェクト)**。  
...
## 私  
私は個人のプログラマーで、長年オンラインゲームのプレイヤーで、ソフトウェア収益化問題や情報技術等について長年考察していました。
