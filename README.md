...
# これは何  
個人によるプロジェクトです。私はソフトウェアのマネタイズ問題等昔からネットに様々な問題を感じていて、そういった問題を解決するために何があればいいか考えがまとまったので、プロジェクトを始めました。

このプロジェクトは[相互評価フローネットワーク](#相互評価フローネットワーク)及びそれを通じた[仮想通貨分配](#仮想通貨分配)によって、オンラインゲームのプレイヤーや動画制作者、配信者、プログラマー、その他ソフトウェア制作者やオンラインサービスの提供者等が[収益化できる状況](#主旨)を目指します。つまりオープンソースや無料サービスやフリーソフト等について、**有料化する事無く[自由な相互利用を保ちながら](#作者権)幅広くネット上での活躍が収益化される状況**を目指します。さらに、様々な創作者が自由に参加できる1つの[連合型MMO](#仮想経済)を構築できます。
