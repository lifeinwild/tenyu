...
public class Const {
	...
	/**
	 * アプリ全体で使用される文字コード。
	 * しかし永続化される文字列の文字コードはこれを使わず
	 * その用途やクラス毎に独自に文字コードを定義すべき場合がある。
	 * ここで設定される文字コードが変更される可能性を想定すると
	 * 永続化されたデータは問題を生じさせやすい。
	 */
	...
	/**
	 * Tenyutalkの永続化処理等でも使用される文字コード
	 */
	private final Charset charsetNioTenyutalk = Charset.forName(charset);

	public Charset getCharsetNioTenyutalk() {
		return charsetNioTenyutalk;
	}
	 ...
	 * 極度に低い衝突率が必要な場合
	 */
	private final String digestAlgorithmSecure = "SHA-512";

	/**
	 * 高速なハッシュ
	 */
	private final String digestAlgorithmFast = "TIGER";
	...
	*/
	...
	public String getDigestAlgorithmSecure() {
		return digestAlgorithmSecure;
	}

	public String getDigestAlgorithmFast() {
		return digestAlgorithmFast;
	}
