 ...
 *
 */
public class RatingGameMatch extends ObjectivityObject
	...
	*/
	...
	protected boolean validateAtCommonObjectivityObjectConcrete(
			ValidationResult r) {
		boolean b = true;
	...
	public String toString() {
		return "RatingGameMatch [conflict=" + conflict + ", createDate="
				...
				+ ", host=" + host + "] " + "id=" + getRecycleId()
				+ " createDate=" + getCreateDate() + " enoughRandom="
