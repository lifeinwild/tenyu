...
public class Util {
	...
	*/
	...
	public MessageDigest getMD() {
		try {
			return MessageDigest.getInstance(
					Glb.getConst().getDigestAlgorithm(),
	...
	public <T> List<T> getExtra(Collection<T> src, List<T> filter) {
	 ...
	 */
	public <T> List<T> getExtra(Collection<T> src, HashSet<T> filter) {
	...
	*/
	...
	public static class ByteArrayWrapper implements Comparable {
		...
		public boolean equals(byte[] pubKey) {
			return Arrays.equals(byteArray, pubKey);
		}
