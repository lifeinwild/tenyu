...
public class CatchUpUpdatedIDListStore extends
		SatelliteStore<Long, CatchUpUpdatedIDList> implements StoreByStore {
	/**
	...
	protected CatchUpUpdatedIDList chainversionup(ByteIterable bi) {
		try {
			if (bi == null)
				return null;
			Object o = cnvO(bi);
			if (o instanceof bei7473p5254d69jcuat.tenyu.release1.global.middle.catchup.CatchUpUpdatedIDList)
				return (bei7473p5254d69jcuat.tenyu.release1.global.middle.catchup.CatchUpUpdatedIDList) o;
