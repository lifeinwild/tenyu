...
/**
 * build系メソッドはsbfを必ず受け取る。
 * sbfは送信ボタン押下時の動作を決定する。
 *
 ...
 *
 */
public abstract class ModelGui<O> {
	 ...
	 *
	 * @param name	GUIの名前
	 * @param id	各GUI部品のidの接頭辞になる
	 * @param ctx
	 */
	public ModelGui(String name, String id) {
		this.grid = GuiBuilder.grid(id);
	 ...
	 */
	public void add(ModelGui<?> guiPart) {
	...
	public GridPane buildDelete(O exist) {
	 ...
	 * @return
	 */
	public GridPane buildUpdate(O exist) {
