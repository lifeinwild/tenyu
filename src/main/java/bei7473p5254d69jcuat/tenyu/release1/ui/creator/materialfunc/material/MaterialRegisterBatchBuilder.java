...
public class MaterialRegisterBatchBuilder extends GuiBuilder {
	@Override
	public Node build() {
		GuiCommon.onlyUser(name());
		MaterialListGui builtList = new MaterialListGui(name(), id());
		builtList.buildCreateBatch();
	...
	@Override
	public String name() {
		return Lang.MATERIAL_REGISTER_BATCH.toString();
	}

	@Override
	public String id() {
		return "materialRegisterBatch";
	}
