...
public class TagGui extends
		IndividualityObjectGui<TagI, Tag, Tag, TagStore, TagGui, TagTableItem> {

	public TagGui(String name, String id) {
		super(name, id);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	@Override
	protected TagGui createDetailGui() {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}

	@Override
	protected TagTableItem createTableItem(Tag o) {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
