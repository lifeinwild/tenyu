 ...
 *
 */
public class EdgeManager implements ValidatableI {
	/**
	 * エッジの数の最大値
	 * 全ノードタイプのうちの最大値であり、
	...
	public Edge remove(Long socialityId, long historyIndex) {
		Edge e = edges.remove(socialityId);
		if (e == null)
			return null;
		changeAmount.add(-e.getWeight(), historyIndex);
		return e;
	}
