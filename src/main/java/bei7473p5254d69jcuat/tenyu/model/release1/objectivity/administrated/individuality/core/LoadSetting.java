 ...
 *
 */
public class LoadSetting implements ValidatableI {
	/**
	...
	public String toString() {
		return "LoadSetting [userMessageListApplySizeMax="
				+ userMessageListApplySizeMax + ", bandwidthMin=" + bandwidthMin
				+ ", messageSizeMax=" + messageSizeMax + ", serverCountMax="
				+ serverCountMax + ", userMessageCountMaxAdmin="
				+ userMessageCountMaxAdmin + ", userMessageCountMaxAuthor="
				+ userMessageCountMaxAuthor + ", userMessageCountMaxStandard="
				+ userMessageCountMaxStandard
				+ ", userMessageListHistoryIndexTolerance="
				+ userMessageListHistoryIndexTolerance
				+ ", userMessageListSizeMax=" + userMessageListSizeMax + "]";
	}
