package bei7473p5254d69jcuat.tenyu.model.release1.objectivity.administrated.individuality.game.item.instance;
...
public class RatingGameEquipmentInstance implements ValidatableI {
	/**
	 * オプションの最大数
	 */
