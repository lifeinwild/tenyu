...
public class RatingGame extends IndividualityObject implements RatingGameI {
	...
	public static boolean createSequence(Transaction txn, RatingGame rg,
		...
		return ObjectivitySequence.createSequence(txn, rg, specifiedId,
				historyIndex, rg.getRegistererUserId(),
				rg.getRegistererUserId(), StoreNameObjectivity.RATING_GAME);
	}

	public static boolean deleteSequence(Transaction txn, RatingGame u)
			throws Exception {
		return ObjectivitySequence.deleteSequence(txn, u,
				StoreNameObjectivity.RATING_GAME);
	}
	...
	@Override
	public RatingGameGui getGuiReferenced(String guiName, String cssIdPrefix) {
