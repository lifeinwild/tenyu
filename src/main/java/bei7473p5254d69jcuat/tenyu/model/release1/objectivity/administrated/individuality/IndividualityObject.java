...
public abstract class IndividualityObject extends AdministratedObject
	...
	public static boolean validateName(Lang n, String name,
			ValidationResult vr) {
		return validateName(n, name, vr, IndividualityObjectI.getNameMaxStatic());
	}
	...
	public static boolean validateName(String name, ValidationResult vr) {
		return validateName(name, vr, IndividualityObjectI.getNameMaxStatic());
	}
	 ...
	 * この個性オブジェクト固有のCSS
	 */
	protected TenyuReferenceArtifactByVersionMajor css;
	...
	public boolean addTag(Long tagId) {
		if (tagId == null || tagIds.size() > tagIdsMax || tagIds.contains(tagId)
				|| tagId.equals(getId()))
			return false;
	...
	@Override
	abstract public IndividualityObjectGui<?, ?, ?, ?, ?, ?> getGuiReferenced(
	...
	public String toString() {
		return "IndividualityObject [css=" + css + ", explanation="
				...
				+ ", tagIds=" + tagIds + ", toString()=" + super.toString()
				+ "]";
	}
	...
	public TenyuReferenceArtifactByVersionMajor getCss() {
		return css;
	}

	public void setCss(TenyuReferenceArtifactByVersionMajor css) {
		this.css = css;
	}

	@SuppressWarnings("unchecked")
	public TenyuReferenceModelI<? extends IndividualityObjectI> getReference() {
		return (TenyuReferenceModelI<
				? extends IndividualityObjectI>) super.getReference();
	}
