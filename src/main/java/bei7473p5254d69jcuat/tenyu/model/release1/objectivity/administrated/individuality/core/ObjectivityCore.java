 ...
 *
 */
public class ObjectivityCore extends IndividualityObject
		implements ObjectivityCoreI {
	...
	@Override
	public TenyuReferenceModelSingle<ObjectivityCore> getReference() {
		return new TenyuReferenceModelSingle<>(
				StoreNameSingle.OBJECTIVITY_CORE);
	}
	...
	@Override
	public ObjectivityCoreGui getGuiReferenced(String guiName, String cssIdPrefix) {
	 ...
	 */
	public ObjectivityCore() {
		setName("Cooperative Account");
		explanation = "The central node of the tenyu flow network";
		SingleObjectStoreI.setup(this);
		//coreは作成日時を全ノードで同じにする必要がある
		setCreateDate(0L);
		setUpdateDate(0L);
		setCreateHistoryIndex(0L);
		setUpdateHistoryIndex(0L);
	...
	*/
	...
	@Override
	public boolean validateAtUpdateChangeIndividualityObjectConcrete(
	...
	public String toString() {
		return "ObjectivityCore [config=" + config
				...
				+ managerList + ", flowComputationState=" + flowComputationState
	...
	public void setFlowComputationState(
			FlowComputationState flowComputationState) {
