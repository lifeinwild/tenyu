package bei7473p5254d69jcuat.tenyu.model.release1.objectivity.administrated.individuality.role;
...
public class Role extends IndividualityObject implements RoleI {
	...
	@Override
	public RoleGui getGuiReferenced(String guiName, String cssIdPrefix) {
